	...
	this.model.findOne( query,
		( function onResult( error, modelData ){
			if( error ){
				...
				this.result( new Error( "cannot update non-existing queried data" ) );
...
Model.prototype.edit = function edit( property, value, reference ){
	...
	modelQuery.exec( ( function onEdit( error, modelDataList ){
		...
		}else if( _.isEmpty( modelDataList ) ){
			this.result( new Error( "cannot edit non-existing queried data" ) );
